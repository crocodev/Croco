...
SubMenu::SubMenu(void)
{
	...
	//menu icons
	CCMenuItem* itm_3gamers = CCMenuItemImage::itemFromNormalImage(SubMenu_3gamers,SubMenu_3gamers,this,menu_selector(SubMenu::itm_3gamersCallback));
	CCMenuItem* itm_2groups = CCMenuItemImage::itemFromNormalImage(SubMenu_2groups,SubMenu_2groups,this,menu_selector(SubMenu::itm_2groupsCallback));
	CCMenuItem* itm_3groups = CCMenuItemImage::itemFromNormalImage(SubMenu_3groups,SubMenu_3groups,this,menu_selector(SubMenu::itm_3groupsCallback));
	CCMenuItem* itm_4groups = CCMenuItemImage::itemFromNormalImage(SubMenu_4groups,SubMenu_4groups,this,menu_selector(SubMenu::itm_4groupsCallback));
	CCMenuItem* itm_back = CCMenuItemImage::itemFromNormalImage(GroupCustomization_back,GroupCustomization_back_selected,this,menu_selector(SubMenu::itm_backCallback));
