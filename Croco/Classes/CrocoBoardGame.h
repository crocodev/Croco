...
#define ADDBGMUSIC(MUSIC)               SimpleAudioEngine::sharedEngine()->preloadBackgroundMusic(CCFileUtils::fullPathFromRelativePath(MUSIC));
#define ADDEFFECT(EFFECT)               SimpleAudioEngine::sharedEngine()->preloadEffect( CCFileUtils::fullPathFromRelativePath(EFFECT));

// play background music
#define PLAYBGMUSIC(MUSIC)              SimpleAudioEngine::sharedEngine()->playBackgroundMusic(std::string(CCFileUtils::fullPathFromRelativePath(MUSIC)).c_str(), true);
...
#define PLAYEFFECT(EFFECT)              SimpleAudioEngine::sharedEngine()->playEffect(std::string(CCFileUtils::fullPathFromRelativePath(EFFECT)).c_str());
/* play effect recursive
   return unsigned int EFFECTID */
#define PLAYEFFECTRECURSE(EFFECT)       SimpleAudioEngine::sharedEngine()->playEffect(std::string(CCFileUtils::fullPathFromRelativePath(EFFECT)).c_str(), true);
// stop effect
#define STOPEFFECT(EFFECTID)            SimpleAudioEngine::sharedEngine()->stopEffect(EFFECTID);
// unload effect
#define UNLOADEFFECT(EFFECT)            SimpleAudioEngine::sharedEngine()->unloadEffect(std::string(CCFileUtils::fullPathFromRelativePath(EFFECT)).c_str());
