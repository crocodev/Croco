...
{	
	...
	((CurrentGroupLayer*)((GroupCustomization*)this->getParent())->layers.getObjectAtIndex(currentScreen-1))->setContentAccess(1);
}
...
{	
	...
	if(((CurrentGroupLayer*)((GroupCustomization*)this->getParent())->layers.getObjectAtIndex(currentScreen-1))->m_isAccessable)
		((CurrentGroupLayer*)((GroupCustomization*)this->getParent())->layers.getObjectAtIndex(currentScreen-1))->setContentAccess(0);
